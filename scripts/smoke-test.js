...
const required=["admin/diagnostics","push/key","admin/audit","admin/backups","admin/archive","public/version","cron/maintenance","cron/birthdays","admin/push/subscriptions","admin/employees/gender"];
