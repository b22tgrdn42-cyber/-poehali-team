...
const required=["admin/diagnostics","push/key","tutorial/capabilities","tutorial/base-offered","tutorial/state","admin/audit","admin/backups","admin/archive","public/version","cron/maintenance","cron/birthdays","cron/news-reminders","admin/push/subscriptions","admin/employees/gender"];
